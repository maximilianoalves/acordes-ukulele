...
function montPageHome($nota){
	...
	foreach ($types as $value) {
		$api_url = 'http://www.ukulele-chords.com/get?ak=d41d8cd98f00b204e9800998ecf8427e&r='.$nota.'&typ='.$value;
		getFirstChord($api_url, $value, $nota);
	}
}
...
function getFirstChord($api_url, $value, $nota){
	//XML file to load
	//converts the specified XML file into a SimpleXMLElement object
	$xml = simplexml_load_file($api_url);
	//Navigate through the tree to get your info (chord diagram here)
